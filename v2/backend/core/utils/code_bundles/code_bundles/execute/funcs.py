...
def read_root_publish_analysis() -> bool:
    """
    Read config/packager.yml and return the nested publish.publish_analysis flag.
    This controls whether GitHub publish includes design_manifest/analysis/**.
    """
    try:
        ...
        return bool(pub.get("publish_analysis", False))
    except Exception as e:
