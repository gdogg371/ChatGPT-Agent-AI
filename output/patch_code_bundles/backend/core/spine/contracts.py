...
# File: v2/backend/core/spine/contracts.py
...
class Envelope:
    ...
    trace_id: str
    producer: str
    intent: str            # discover|analyze|plan|patch|verify|publish|heartbeat
    subject: str           # res://..., file://..., git://..., etc.
    capability: str        # e.g., "analyze.docstrings.v1"
...
class Task:
    ...
    The payload schema name should match capability family, e.g. "analyze.docstrings.v1".
    """
    envelope: Envelope
    payload_schema: str
...
class Problem:
    ...
    """
    code: str                # e.g., ValidationError | CapabilityUnavailable | ...
    message: str
