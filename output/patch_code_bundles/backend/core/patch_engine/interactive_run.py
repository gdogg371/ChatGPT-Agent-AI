...
if __name__ == "__main__":
    ...
    With promotion disabled (default), no live mirror changes will be made.
    ...
    cfg = PatchEngineConfig(
        ...
        # Promotion remains disabled explicitly.
        promotion_enabled=False,
    )
    ...
    manifest = run_one(PATCH_FILE, cfg)
