...
class Contracts:
    ...
    def build_run_manifest(
        *, inputs: List[FileRec], outputs: Dict[str, Any], codebase_root: str = "codebase/"
    ) -> Dict[str, Any]:
        """
...
def build_run_manifest(*, inputs: List[FileRec], outputs: Dict[str, Any], codebase_root: str = "codebase/") -> Dict[str, Any]:
