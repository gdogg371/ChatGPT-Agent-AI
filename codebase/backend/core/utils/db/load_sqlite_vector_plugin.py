...
# ---- Config ----
PLUGINS_DIR = Path(r"/tests_adhoc")
SCHEMAS_DIR = Path(r"/scripts/sqlite_sql_schemas")
DEFAULT_DB = r"sqlite:///C:/Users/cg371/PycharmProjects/ChatGPT Bot/databases/bot_dev.db"
